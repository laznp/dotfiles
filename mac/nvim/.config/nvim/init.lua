...
vim.keymap.set('n', '<C-t>', toggle_float_term, { noremap = true, silent = true })
vim.keymap.set('t', '<C-t>', function() vim.api.nvim_win_hide(float_term.win) end, { noremap = true, silent = true })

...
bg_default = "#1e2127"          # main shade darkest
bg_lighter = "#353b45"
bg_selection = "#3e4451"
# "#545862"
fg_disabled = "#565c64"
...
c.colors.tabs.pinned.selected.even.bg = fg_disabled

# Foreground color of pinned selected even tabs.
c.colors.tabs.pinned.selected.even.fg = bg_default

# Background color of pinned selected odd tabs.
c.colors.tabs.pinned.selected.odd.bg = fg_disabled
